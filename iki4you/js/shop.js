/* project i v1.0.2 | (c) 2019 Nan Hang Lim (@nanhanglim)  */
...
function offBST() {
  document.getElementById("pmu").addEventListener("click", function(){
  document.getElementById("boxSelectText").display = "none";
});
}

function offTST() {
  document.getElementById("bycTime").addEventListener("click", function(){
  document.getElementById("timeSelectText").display = "none";
});
}

function offCST() {
  document.getElementById("aft").addEventListener("click", function(){
  document.getElementById("cardSelectText").display = "none";
});
}

function offLST() {
  document.getElementById("aftPackage").addEventListener("click", function(){
